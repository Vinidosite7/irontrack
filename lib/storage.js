...
// A chave inclui o userId — cada conta tem seu próprio cache local isolado.
// Sem isso, trocar de conta no mesmo navegador fazia o app carregar o cache
// da conta anterior antes de perceber que era um usuário novo sem dados.
const keyFor = (userId) => `irontrack:data:${userId}`;
...
if (typeof window !== "undefined") {
  ...
  // limpa a chave antiga (sem escopo por usuário) de versões anteriores do app
  try { localStorage.removeItem("irontrack:data"); } catch {}
}
